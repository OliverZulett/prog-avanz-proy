        ...
        <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
          <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
            <div class="flex items-center mb-2">
              <span class="text-3xl leading-normal mb-2 font-bold text-gray-800 mt-2">Programación Avanzada</span>
              <!-- <img src="img-min/logo.png" alt="LOGO"> -->
            </div>
            <p>Ejercicios de distinto tipo que nos ayudan a mejorar nuestras habilidades de programación.</p>
      ...
      <div class="container xl:max-w-6xl mx-auto px-4 py-4 border-t border-gray-200 border-opacity-10">
        <div class="row">
          <div class="col-12 col-md text-center">
            <p class="d-block my-3">Copyright © Oliver Zulett | USFA.</p>
          </div>
        </div>
      </div>
    </div>
